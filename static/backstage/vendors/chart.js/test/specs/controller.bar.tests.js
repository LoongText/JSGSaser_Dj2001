describe('Chart.controllers.bar', function() {
	...
	it('should correctly get the stack backstage accounting for datasets of other types and hidden datasets', function() {
		[
			'bar',
			'horizontalBar'
		].forEach(function(barType) {
	...
	it('should correctly get the stack backstage when a group is not specified', function() {
		[
			'bar',
			'horizontalBar'
		].forEach(function(barType) {
	...
	it('should correctly get the stack backstage when a group is not specified and the scale is stacked', function() {
		[
			'bar',
			'horizontalBar'
		].forEach(function(barType) {
	...
	it('should correctly get the stack backstage when a group is not specified and the scale is not stacked', function() {
		[
			'bar',
			'horizontalBar'
		].forEach(function(barType) {
	...
	it('should correctly get the stack backstage when a group is specified for some', function() {
		[
			'bar',
			'horizontalBar'
		].forEach(function(barType) {
	...
	it('should correctly get the stack backstage when a group is specified for some and the scale is stacked', function() {
		[
			'bar',
			'horizontalBar'
		].forEach(function(barType) {
	...
	it('should correctly get the stack backstage when a group is specified for some and the scale is not stacked', function() {
		[
			'bar',
			'horizontalBar'
		].forEach(function(barType) {
	...
	it('should correctly get the stack backstage when a group is specified for all', function() {
		[
			'bar',
			'horizontalBar'
		].forEach(function(barType) {
	...
	it('should correctly get the stack backstage when a group is specified for all and the scale is stacked', function() {
		[
			'bar',
			'horizontalBar'
		].forEach(function(barType) {
	...
	it('should correctly get the stack backstage when a group is specified for all and the scale is not stacked', function() {
		[
			'bar',
			'horizontalBar'
		].forEach(function(barType) {
