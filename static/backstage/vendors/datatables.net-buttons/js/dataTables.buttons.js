...
$.extend( Buttons.prototype, {
	 ...
	 * @param  {int|string} Button backstage
	 * @return {function}
	 *//**
	 ...
	 * @param {int|string} [idx] Button backstage for where to insert the button
	 * @return {Buttons} Self for chaining
	 */
	 ...
	 * @param  {int|string} node Button backstage
	 * @return {string} Button text
	 *//**
	 * Set the text for a button
	 * @param  {int|string|function} node Button backstage
...
Buttons.buttonSelector = function ( insts, selector )
{
	...
	var run = function ( selector, inst ) {
		...
		if ( selector === null || selector === undefined || selector === '*' ) {
			...
			// Main button backstage selector
			ret.push( {
				inst: inst,
