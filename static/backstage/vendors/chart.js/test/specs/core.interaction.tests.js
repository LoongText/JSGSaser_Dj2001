...
describe('Core.Interaction', function() {
	...
	describe('backstage mode', function() {
	...
	describe('nearest mode', function() {
		describe('intersect: false', function() {
			...
			it ('should return the lowest dataset backstage if size and area are the same', function() {
				var chart = this.chart;
				// Make equal sized points at backstage: 1
		...
		describe('intersect: true', function() {
			...
			it ('should return the item at the lowest dataset backstage if distance and area are the same', function() {
				var chart = this.chart;
